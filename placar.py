...
def placar(screen, pontos_1 , pontos_2):
    ...
    text_placar1 = text_placar_font.render(f'{pontos_1}', True, (90, 100, 240))
    text_placar2 = text_placar_font.render(f'{pontos_2}', True, (90, 100, 240))
    screen.blit(text_placar1, (380,100))
    screen.blit(text_placar2, (980,100))